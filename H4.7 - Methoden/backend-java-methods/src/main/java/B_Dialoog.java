public class B_Dialoog {
    ...
    public static void bertSays(String print) {
        System.out.println("Bert says: " + print);
    }

    public static void ernieSays(String print) {
        System.out.println(print + " says Ernie");
    }
}
